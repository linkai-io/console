        ...
        <div class="table-responsive">
          <table class="table">
            <tbody>
              <tr>
                <td>
                  <div class="flag"><img src="img/US.png" /></div>
                </td>
                <td>USA</td>
              ...
              <tr>
                <td>
                  <div class="flag"><img src="img/DE.png" /></div>
                </td>
                <td>Germany</td>
              ...
              <tr>
                <td>
                  <div class="flag"><img src="img/AU.png" /></div>
                </td>
                <td>Australia</td>
              ...
              <tr>
                <td>
                  <div class="flag"><img src="img/GB.png" /></div>
                </td>
              ...
              <tr>
                <td>
                  <div class="flag"><img src="img/RO.png" /></div>
                </td>
                <td>Romania</td>
              ...
              <tr>
                <td>
                  <div class="flag"><img src="img/BR.png" /></div>
                </td>
                <td>Brasil</td>
...
const WorldMap = () => ({
  component: import('src/pages/Maps/WorldMap.vue'),
  loading: Loading,
  delay: 200
});
export default {
